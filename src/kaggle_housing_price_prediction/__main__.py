"""Kaggle Housing Price Prediction file for ensuring the package is executable
as `kaggle-housing-price-prediction` and `python -m kaggle_housing_price_prediction`
"""
import importlib
